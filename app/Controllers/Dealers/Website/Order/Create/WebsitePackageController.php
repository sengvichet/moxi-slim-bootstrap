...
/**
 * This controller contains actions for the Website Package page.
 *
 * @category Dealers
 * @package  Dealers
 * @author   LAMPDev <oksana@lamp-dev.com>
 ...
 * @link     http://lamp-dev.com
 */
class WebsitePackageController extends CreateOrderController
{
    private $slug = 'website-package';
    /**
    ...
    public function store()
    {
        ...
        return $this->handleNextAction($data['action'], 'start', 'home-page');
    }
