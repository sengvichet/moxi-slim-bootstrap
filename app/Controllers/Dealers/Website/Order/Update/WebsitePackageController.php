<?php
/**
 * This file contains portal's WebsitePackageController.
 *
 * PHP version 7.1
 *
 * @category Dealers
...
/**
 * This controller contains actions for the update Website Package page.
 *
 * @category Dealers
 * @package  Dealers
 * @author   LAMPDev <oksana@lamp-dev.com>
 ...
 * @link     http://lamp-dev.com
 */
class WebsitePackageController extends UpdateOrderController
{
    private $slug = 'update-website-package';
    /**
    ...
    public function index()
    {
        ...
        return $this->render('Dealers/website/order/update/website-package.twig', $data);
    }
    ...
    public function store()
    {
        ...
        return $this->handleNextAction($data['action'], 'welcome', 'home-page');
    }
    ...
    private function getSections(array $data)
    {
        ...
        $costsTypes = $costsTypesModel->getCostsTypes(['group' => 'website_package']);
        if (!$costsTypes) {
            return $sections;
        }
        ...
        if (empty($data['ecommerce']) || $data['ecommerce'] != 2) {
            $sections = array_diff($sections, ['pricing']);
        }
        return $sections;
    }
}
