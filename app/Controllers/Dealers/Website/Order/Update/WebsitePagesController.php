<?php
/**
 * This file contains portal's update WebsitePagesController.
 *
 * PHP version 7.1
 *
 * @category Dealers
...
/**
 * This controller contains actions for the update Website Pages page.
 *
 * @category Dealers
 * @package  Dealers
 * @author   LAMPDev <oksana@lamp-dev.com>
 ...
 * @link     http://lamp-dev.com
 */
class WebsitePagesController extends UpdateOrderController
{
    private $slug = 'update-website-pages';
    /**
    ...
    public function index()
    {
        ...
        return $this->render('Dealers/website/order/update/website-pages.twig', $data);
    }
