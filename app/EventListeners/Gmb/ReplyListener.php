<?php
/**
 * This file contains a listener to a reply event.
 *
 * PHP version 7.1
 *
 * @category Dealers
...
/**
 * This class is a listener to a reply event.
 *
 * @category Dealers
 * @package  Dealers
 * @author   LAMPDev <oksana@lamp-dev.com>
 ...
 * @link     http://lamp-dev.com
 */
class ReplyListener extends AbstractListener
{
    /**
    ...
    {
        extract($params);
        $statuses = $container->gmb_email->sendEmailNotification('reply', $instance);
